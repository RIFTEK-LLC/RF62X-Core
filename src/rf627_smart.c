...
rf627_smart_t* rf627_smart_create_from_hello_msg(char* data, rfUint32 data_size)
{
    ...
    rf627_smart->calib_table.m_Data = NULL;
    rf627_smart->approx_table.table_v6 = NULL;
...
rf627_smart_profile2D_t* rf627_smart_get_profile2D(rf627_smart_t* scanner, rfBool zero_points)
{
    ...
    if(nret > 0)
    {
        ...
        if ((rfUint32)nret > profile_header_size)
        {
            ...
            if (profile->header.proto_version_major == 1 && profile->header.proto_version_minor == 0)
            {
            ...
            else if (profile->header.proto_version_major == 1 && profile->header.proto_version_minor == 1)
            {
                if (profile->header.data_type == SPDT_v1_1_ProfilePoly)
                {
                    ...
                    profile->header.v1_1_polynomial.scaling_factor = header_from_msg.v1_1_polynomial.scaling_factor;
                }else
                {
                    profile->header.v1_1_standart.zmr = header_from_msg.v1_1_standart.zmr;
            ...
            }else if (profile->header.proto_version_major == 1 && profile->header.proto_version_minor == 3)
            {
                if (profile->header.data_type == SPDT_v1_3_ProfilePoly)
                {
                    profile->header.v1_3_polynomial.zmr = header_from_msg.v1_3_polynomial.zmr;
                    profile->header.v1_3_polynomial.xemr = header_from_msg.v1_3_polynomial.xemr;
                    profile->header.v1_3_polynomial.scaling_factor = header_from_msg.v1_3_polynomial.scaling_factor;
                }else
                {
                    profile->header.v1_3_standart.zmr = header_from_msg.v1_3_standart.zmr;
                    profile->header.v1_3_standart.xemr = header_from_msg.v1_3_standart.xemr;
                    profile->header.v1_3_standart.pixels_divider = header_from_msg.v1_3_standart.pixels_divider;
                    profile->header.v1_3_standart.alignment_with_sensor = header_from_msg.v1_3_standart.alignment_with_sensor;
                }
            }
            ...
            if(profile->header.serial_number == scanner->info_by_service_protocol.fact_general_serial)
            {
                ...
                if (profile->header.proto_version_major == 1 && profile->header.proto_version_minor == 0)
                {
                    ...
                    for (rfUint32 i=0; i<pt_count; i++)
                    {
                        ...
                        case SPDT_v1_0_ProfileInterpolated:
                            ...
                            {
                                pt.x = (rfFloat)((rfDouble)(x) * (rfDouble)(profile->header.v1_0_standart.xemr) /
                                                 (rfDouble)(profile->header.v1_0_standart.discrete_value));
                                pt.z = (rfFloat)((rfDouble)(z) * (rfDouble)(profile->header.v1_0_standart.zmr) /
                                                 (rfDouble)(profile->header.v1_0_standart.discrete_value));
                ...
                else if (profile->header.proto_version_major == 1 && profile->header.proto_version_minor == 1)
                {
                    ...
                    for (rfUint32 i=0; i<pt_count; i++)
                    {
                        ...
                        case SPDT_v1_1_ProfileTable:
                            ...
                            if (zero_points == FALSE && z > 0)
                            {
                                pt.x = (rfFloat)((rfDouble)(x) * (rfDouble)(profile->header.v1_1_standart.xemr) /
                                                 (rfDouble)(profile->header.v1_1_standart.discrete_value));
                                pt.z = (rfFloat)((rfDouble)(z) * (rfDouble)(profile->header.v1_1_standart.zmr) /
                                                 (rfDouble)(profile->header.v1_1_standart.discrete_value));
                        ...
                        case SPDT_v1_1_ProfilePoly:
                            ...
                            if (zero_points == FALSE && z > 0)
                            {
                                pt.x = (rfFloat)(x * profile->header.v1_1_polynomial.scaling_factor);
                                pt.z = (rfFloat)(z * profile->header.v1_1_polynomial.scaling_factor);
                ...
                else if (profile->header.proto_version_major == 1 && profile->header.proto_version_minor == 3)
                {
                    switch (profile->header.data_type)
                    {
                    case SPDT_v1_3_Pixels:
                        pt_count = profile->header.payload_size / profile->header.bytes_per_point;
                        profile->pixels_v1_3_format.pixels_count = 0;
                        profile->pixels_v1_3_format.pixels =
                                memory_platform.rf_calloc(pt_count, sizeof (rfUint32));
                        if (profile->header.flags & 0x01){
                            profile->intensity_count = 0;
                            profile->intensity =
                                    memory_platform.rf_calloc(pt_count, sizeof (rfUint8));
                    ...
                    for (rfUint32 i=0; i<pt_count; i++)
                    {
                        ...
                        case SPDT_v1_3_ProfileTable:
                            ...
                            if (zero_points == FALSE && z > 0)
                            {
                                pt.x = (rfFloat)((rfDouble)(x) * (rfDouble)(profile->header.v1_3_standart.xemr) /
                                                 (rfDouble)(profile->header.v1_3_standart.pixels_divider));
                                pt.z = (rfFloat)((rfDouble)(z) * (rfDouble)(profile->header.v1_3_standart.zmr) /
                                                 (rfDouble)(profile->header.v1_3_standart.pixels_divider));
                        ...
                        case SPDT_v1_3_ProfilePoly:
                            ...
                            if (zero_points == FALSE && z > 0)
                            {
                                pt.x = (rfFloat)(x * profile->header.v1_3_polynomial.scaling_factor);
                                pt.z = (rfFloat)(z * profile->header.v1_3_polynomial.scaling_factor);
                            ...
                            break;
                        case SPDT_v1_3_Pixels:
                            if (profile->header.bytes_per_point == 2)
                            {
                                rfUint16 z_ = *(rfUint16*)(&RX[profile_header_size + i*2]);
                                //pt.x = i;

                                profile->pixels_v1_3_format.pixels[profile->pixels_v1_3_format.pixels_count] = z_;
                                profile->pixels_v1_3_format.pixels_count++;
                                if (profile->header.flags & 0x01)
                                {
                                    profile->intensity[profile->intensity_count] = RX[profile_header_size + pt_count*2 + i];
                                    profile->intensity_count++;
                                ...
                                //pt.z = (rfDouble)(z) / (rfDouble)(profile->header.discrete_value);
                            }else if (profile->header.bytes_per_point == 4)
                            {
                                rfUint32 z_ = *(rfUint32*)(&RX[profile_header_size + i*4]);
                                //pt.x = i;
        ...
        if (result != NULL)
        {
            ...
            *array_count = ((answer*)result)->data_size / dump_unit_size;
            ...
            for (uint32_t i = 0; i < *array_count; i++)
            {
                ...
                {
                    profile_array[i]->rf627smart_profile2D->header.v1_0_standart.zmr = header_from_msg.v1_0_standart.zmr;
                    profile_array[i]->rf627smart_profile2D->header.v1_0_standart.xemr = header_from_msg.v1_0_standart.xemr;
                    profile_array[i]->rf627smart_profile2D->header.v1_0_standart.discrete_value = header_from_msg.v1_0_standart.discrete_value;
                }
                ...
                {
                    if (profile_array[i]->rf627smart_profile2D->header.data_type == SPDT_v1_1_ProfilePoly)
                    {
                        profile_array[i]->rf627smart_profile2D->header.v1_1_polynomial.zmr = header_from_msg.v1_1_polynomial.zmr;
                        profile_array[i]->rf627smart_profile2D->header.v1_1_polynomial.xemr = header_from_msg.v1_1_polynomial.xemr;
                        profile_array[i]->rf627smart_profile2D->header.v1_1_polynomial.scaling_factor = header_from_msg.v1_1_polynomial.scaling_factor;
                    }else
                    {
                        profile_array[i]->rf627smart_profile2D->header.v1_1_standart.zmr = header_from_msg.v1_1_standart.zmr;
                        profile_array[i]->rf627smart_profile2D->header.v1_1_standart.xemr = header_from_msg.v1_1_standart.xemr;
                         ...
                         profile_array[i]->rf627smart_profile2D->header.proto_version_minor == 2)
                {
                    ...
                    }else
                    {
                        ...
                        profile_array[i]->rf627smart_profile2D->header.v1_2_standart.alignment_with_sensor = header_from_msg.v1_2_standart.alignment_with_sensor;
                    }
                }
                else if (profile_array[i]->rf627smart_profile2D->header.proto_version_major == 1 &&
                         profile_array[i]->rf627smart_profile2D->header.proto_version_minor == 3)
                {
                    if (profile_array[i]->rf627smart_profile2D->header.data_type == SPDT_v1_3_ProfilePoly)
                    {
                        profile_array[i]->rf627smart_profile2D->header.v1_3_polynomial.zmr = header_from_msg.v1_3_polynomial.zmr;
                        profile_array[i]->rf627smart_profile2D->header.v1_3_polynomial.xemr = header_from_msg.v1_3_polynomial.xemr;
                        profile_array[i]->rf627smart_profile2D->header.v1_3_polynomial.scaling_factor = header_from_msg.v1_3_polynomial.scaling_factor;
                    }else
                    {
                        profile_array[i]->rf627smart_profile2D->header.v1_3_standart.zmr = header_from_msg.v1_3_standart.zmr;
                        profile_array[i]->rf627smart_profile2D->header.v1_3_standart.xemr = header_from_msg.v1_3_standart.xemr;
                        profile_array[i]->rf627smart_profile2D->header.v1_3_standart.pixels_divider = header_from_msg.v1_3_standart.pixels_divider;
                        profile_array[i]->rf627smart_profile2D->header.v1_3_standart.alignment_with_sensor = header_from_msg.v1_3_standart.alignment_with_sensor;
                    }
                }
                ...
                if(profile_array[i]->rf627smart_profile2D->header.serial_number == scanner->info_by_service_protocol.fact_general_serial)
                {
                            ...
                            profile_array[i]->rf627smart_profile2D->header.proto_version_minor == 0)
                    {
                        ...
                        for (rfUint32 ii=0; ii<pt_count; ii++)
                        {
                            ...
                            case SPDT_v1_0_ProfileInterpolated:
                                ...
                                {
                                    pt.x = (rfFloat)((rfDouble)(x) * (rfDouble)(profile_array[i]->rf627smart_profile2D->header.v1_0_standart.xemr) /
                                                     (rfDouble)(profile_array[i]->rf627smart_profile2D->header.v1_0_standart.discrete_value));
                                    pt.z = (rfFloat)((rfDouble)(z) * (rfDouble)(profile_array[i]->rf627smart_profile2D->header.v1_0_standart.zmr) /
                                                     (rfDouble)(profile_array[i]->rf627smart_profile2D->header.v1_0_standart.discrete_value));
                        ...
                        for (rfUint32 ii=0; ii<pt_count; ii++)
                        {
                            ...
                            case SPDT_v1_1_ProfileTable:
                                ...
                                if (zero_points == FALSE && z > 0)
                                {
                                    ...
                                    pt.z = (rfFloat)((rfDouble)(z) * (rfDouble)(profile_array[i]->rf627smart_profile2D->header.v1_1_standart.zmr) /
                                                     (rfDouble)(profile_array[i]->rf627smart_profile2D->header.v1_1_standart.discrete_value));
                              ...
                              profile_array[i]->rf627smart_profile2D->header.proto_version_minor == 3)
                    {
                        ...
                        case SPDT_v1_3_Pixels:
                            pt_count = profile_array[i]->rf627smart_profile2D->header.payload_size / profile_array[i]->rf627smart_profile2D->header.bytes_per_point;
                            profile_array[i]->rf627smart_profile2D->pixels_v1_3_format.pixels_count = 0;
                            profile_array[i]->rf627smart_profile2D->pixels_v1_3_format.pixels =
                                    memory_platform.rf_calloc(pt_count, sizeof (rfUint32));
                            if (profile_array[i]->rf627smart_profile2D->header.flags & 0x01){
                                profile_array[i]->rf627smart_profile2D->intensity_count = 0;
                                profile_array[i]->rf627smart_profile2D->intensity =
                        ...
                        for (rfUint32 ii=0; ii<pt_count; ii++)
                        {
                            ...
                            case SPDT_v1_3_ProfileTable:
                                ...
                                if (zero_points == FALSE && z > 0)
                                {
                                    pt.x = (rfFloat)((rfDouble)(x) * (rfDouble)(profile_array[i]->rf627smart_profile2D->header.v1_3_standart.xemr) /
                                                     (rfDouble)(profile_array[i]->rf627smart_profile2D->header.v1_3_standart.pixels_divider));
                                    pt.z = (rfFloat)((rfDouble)(z) * (rfDouble)(profile_array[i]->rf627smart_profile2D->header.v1_3_standart.zmr) /
                                                     (rfDouble)(profile_array[i]->rf627smart_profile2D->header.v1_3_standart.pixels_divider));
                            ...
                            case SPDT_v1_3_ProfilePoly:
                                ...
                                if (zero_points == FALSE && z > 0)
                                {
                                    pt.x = (rfFloat)(x * profile_array[i]->rf627smart_profile2D->header.v1_3_polynomial.scaling_factor);
                                    pt.z = (rfFloat)(z * profile_array[i]->rf627smart_profile2D->header.v1_3_polynomial.scaling_factor);
                                ...
                                break;
                            case SPDT_v1_3_Pixels:
                                if (profile_array[i]->rf627smart_profile2D->header.bytes_per_point == 2)
                                {
                                    z = *(rfUint16*)(&((rfUint8*)(&(((answer*)result)->data[i * dump_unit_size])))[profile_header_size + ii*2]);
                                    //pt.x = i;

                                    profile_array[i]->rf627smart_profile2D->pixels_v1_3_format.pixels[profile_array[i]->rf627smart_profile2D->pixels_v1_3_format.pixels_count] = z;
                                    profile_array[i]->rf627smart_profile2D->pixels_v1_3_format.pixels_count++;
                                    if (profile_array[i]->rf627smart_profile2D->header.flags & 0x01)
                                    {
                                        profile_array[i]->rf627smart_profile2D->intensity[profile_array[i]->rf627smart_profile2D->intensity_count] = ((rfUint8*)(&(((answer*)result)->data[i * dump_unit_size])))[profile_header_size + pt_count*2 + ii];
                                        profile_array[i]->rf627smart_profile2D->intensity_count++;
                                    ...
                                    //pt.z = (rfDouble)(z) / (rfDouble)(profile->header.discrete_value);
                                }else if (profile_array[i]->rf627smart_profile2D->header.bytes_per_point == 4)
                                {
                                    rfUint32 z_ = *(rfUint32*)(&((rfUint8*)(&(((answer*)result)->data[i * dump_unit_size])))[profile_header_size + ii*4]);
                                    //pt.x = i;

                                    profile_array[i]->rf627smart_profile2D->pixels_v1_3_format.pixels[profile_array[i]->rf627smart_profile2D->pixels_v1_3_format.pixels_count] = z_;
                                    profile_array[i]->rf627smart_profile2D->pixels_v1_3_format.pixels_count++;
                                    if (profile_array[i]->rf627smart_profile2D->header.flags & 0x01)
                                    {
                                        profile_array[i]->rf627smart_profile2D->intensity[profile_array[i]->rf627smart_profile2D->intensity_count] = ((rfUint8*)(&(((answer*)result)->data[i * dump_unit_size])))[profile_header_size + pt_count*4 + ii];
...
//
rfInt8 rf627_smart_read_calibration_table_callback(char* data, uint32_t data_size, uint32_t device_id, void* rqst_msg)
{
    answ_count++;
    RF62X_msg_t* msg = rqst_msg;
    int32_t status = FALSE;
...
rfInt8 rf627_smart_read_calibration_table_timeout_callback(void* rqst_msg)
{
    RF62X_msg_t* msg = rqst_msg;
...
rfInt8 rf627_smart_read_calibration_table_free_result_callback(void* rqst_msg)
{
    RF62X_msg_t* msg = rqst_msg;
...
rfBool rf627_smart_read_calibration_table_by_service_protocol(rf627_smart_t* scanner, rfUint32 timeout)
{
    ...
    uint32_t resends                    = is_confirmation ? 3 : 0;
    // callbacks for request
    RF62X_answ_callback answ_clb        = rf627_smart_read_calibration_table_callback;
    RF62X_timeout_callback timeout_clb  = rf627_smart_read_calibration_table_timeout_callback;
    RF62X_free_callback free_clb        = rf627_smart_read_calibration_table_free_result_callback;
...
rfInt8 rf627_smart_write_calibration_table_callback(char* data, uint32_t data_size, uint32_t device_id, void* rqst_msg)
{
    answ_count++;
    RF62X_msg_t* msg = rqst_msg;
    int32_t status = FALSE;
...
rfInt8 rf627_smart_write_calibration_table_timeout_callback(void* rqst_msg)
{
    RF62X_msg_t* msg = rqst_msg;
...
rfInt8 rf627_smart_write_calibration_table_free_result_callback(void* rqst_msg)
{
    RF62X_msg_t* msg = rqst_msg;
...
rfBool rf627_smart_write_calibration_table_by_service_protocol(rf627_smart_t* scanner, rfUint32 timeout)
{
    // Create payload
    mpack_writer_t writer;
    ...
    uint32_t resends                    = is_confirmation ? 3 : 0;
    // callbacks for request
    RF62X_answ_callback answ_clb        = rf627_smart_write_calibration_table_callback;
    RF62X_timeout_callback timeout_clb  = rf627_smart_write_calibration_table_timeout_callback;
    RF62X_free_callback free_clb        = rf627_smart_write_calibration_table_free_result_callback;
...
//
rfInt8 rf627_smart_save_calibration_table_callback(char* data, uint32_t data_size, uint32_t device_id, void* rqst_msg)
{
    answ_count++;
    RF62X_msg_t* msg = rqst_msg;
    int32_t status = FALSE;
...
rfInt8 rf627_smart_save_calibration_table_timeout_callback(void* rqst_msg)
{
    RF62X_msg_t* msg = rqst_msg;
...
rfInt8 rf627_smart_save_calibration_table_free_result_callback(void* rqst_msg)
{
    RF62X_msg_t* msg = rqst_msg;
...
rfBool rf627_smart_save_calibration_table_by_service_protocol(rf627_smart_t* scanner, rfUint32 timeout)
{
    // cmd_name - this is logical port/path where data will be send
    ...
    uint32_t resends                    = is_confirmation ? 3 : 0;
    // callbacks for request
    RF62X_answ_callback answ_clb        = rf627_smart_save_calibration_table_callback;
    RF62X_timeout_callback timeout_clb  = rf627_smart_save_calibration_table_timeout_callback;
    RF62X_free_callback free_clb        = rf627_smart_save_calibration_table_free_result_callback;
...
//
// RF627-Smart (v2.x.x)
// Read Approx Table v6 Method (TODO Parse Type)
//
rfInt8 rf627_smart_read_approx_table_v6_callback(char* data, uint32_t data_size, uint32_t device_id, void* rqst_msg)
{
    answ_count++;
    RF62X_msg_t* msg = rqst_msg;
    int32_t status = FALSE;
...
rfInt8 rf627_smart_read_approx_table_v6_timeout_callback(void* rqst_msg)
{
    RF62X_msg_t* msg = rqst_msg;
...
rfInt8 rf627_smart_read_approx_table_v6_free_result_callback(void* rqst_msg)
{
    RF62X_msg_t* msg = rqst_msg;
...
rfBool rf627_smart_read_approx_table_v6_by_service_protocol(rf627_smart_t* scanner, rfUint32 timeout)
{
    return rf627_smart_create_approx_table_v6(scanner);
...
//
// RF627-Smart (v2.x.x)
// Write Approx Table v6 Method
//
rfInt8 rf627_smart_write_approx_table_v6_callback(char* data, uint32_t data_size, uint32_t device_id, void* rqst_msg)
{
    answ_count++;
    RF62X_msg_t* msg = rqst_msg;
    int32_t status = FALSE;
...
rfInt8 rf627_smart_write_approx_table_v6_timeout_callback(void* rqst_msg)
{
    RF62X_msg_t* msg = rqst_msg;
...
rfInt8 rf627_smart_write_approx_table_v6_free_result_callback(void* rqst_msg)
{
    RF62X_msg_t* msg = rqst_msg;
...
rfBool rf627_smart_write_approx_table_v6_by_service_protocol(rf627_smart_t* scanner, rfUint32 timeout)
{
    // Create payload
    mpack_writer_t writer;
    char* buffer = NULL; //< A growing array for msg.
    size_t buffer_size = 0;	//< Number of msg bytes.
    mpack_writer_init_growable(&writer, &buffer, &buffer_size);

    // payload: (mpack)
    // {
    //    version: Number (uint32_t)
    //    crc_x: Number (uint32_t)
    //    crc_z: Number (uint32_t)
    //    serial: Number (uint32_t)
    //    width: Number (uint32_t)
    //    height: Number (uint32_t)
    //    scaling_factor: Number (float)
    //    polynomial_degree_x: Number (uint32_t)
    //    polynomial_degree_z: Number (uint32_t)
    //    time_stamp: Number (uint32_t)
    //    poly_coef_x: blob
    //    poly_coef_z: blob
    // }
    ...
    mpack_start_map(&writer, 12);
    {
        ...
        mpack_write_uint(&writer, scanner->approx_table.table_v6->version);

        mpack_write_cstr(&writer, "crc_x");
        mpack_write_uint(&writer, scanner->approx_table.table_v6->crc_x);

        mpack_write_cstr(&writer, "crc_z");
        mpack_write_uint(&writer, scanner->approx_table.table_v6->crc_z);

        mpack_write_cstr(&writer, "serial");
        mpack_write_uint(&writer, scanner->approx_table.table_v6->serial);

        mpack_write_cstr(&writer, "width");
        mpack_write_uint(&writer, scanner->approx_table.table_v6->width);

        mpack_write_cstr(&writer, "height");
        mpack_write_uint(&writer, scanner->approx_table.table_v6->height);

        mpack_write_cstr(&writer, "scaling_factor");
        mpack_write_float(&writer, scanner->approx_table.table_v6->scaling_factor);

        mpack_write_cstr(&writer, "polynomial_degree_x");
        mpack_write_uint(&writer, scanner->approx_table.table_v6->polynomial_degree_x);

        mpack_write_cstr(&writer, "polynomial_degree_z");
        mpack_write_uint(&writer, scanner->approx_table.table_v6->polynomial_degree_z);

        mpack_write_cstr(&writer, "time_stamp");
        mpack_write_uint(&writer, scanner->approx_table.table_v6->time_stamp);

        mpack_write_cstr(&writer, "poly_coef_x");
        mpack_write_bin(&writer,
                        (rfChar*)scanner->approx_table.table_v6->poly_coef_x,
                        scanner->approx_table.table_v6->width *
                        scanner->approx_table.table_v6->polynomial_degree_x *
                        sizeof(rfFloat));

        mpack_write_cstr(&writer, "poly_coef_z");
        mpack_write_bin(&writer,
                        (rfChar*)scanner->approx_table.table_v6->poly_coef_z,
                        scanner->approx_table.table_v6->width *
                        scanner->approx_table.table_v6->polynomial_degree_z *
                        sizeof(rfFloat));
    ...
    uint32_t resends                    = is_confirmation ? 3 : 0;
    // callbacks for request
    RF62X_answ_callback answ_clb        = rf627_smart_write_approx_table_v6_callback;
    RF62X_timeout_callback timeout_clb  = rf627_smart_write_approx_table_v6_timeout_callback;
    RF62X_free_callback free_clb        = rf627_smart_write_approx_table_v6_free_result_callback;
...
//
// RF627-Smart (v2.x.x)
// Save Approx Table v6 Method
//
rfInt8 rf627_smart_save_approx_table_v6_callback(char* data, uint32_t data_size, uint32_t device_id, void* rqst_msg)
{
    answ_count++;
    RF62X_msg_t* msg = rqst_msg;
    int32_t status = FALSE;
...
rfInt8 rf627_smart_save_approx_table_v6_timeout_callback(void* rqst_msg)
{
    RF62X_msg_t* msg = rqst_msg;
...
rfInt8 rf627_smart_save_approx_table_v6_free_result_callback(void* rqst_msg)
{
    RF62X_msg_t* msg = rqst_msg;
...
rfBool rf627_smart_save_approx_table_v6_by_service_protocol(rf627_smart_t* scanner, rfUint32 timeout)
{
    // cmd_name - this is logical port/path where data will be send
    char* cmd_name                      = "SAVE_CALIBRATION_DATA";
    // payload - this is the data to be sent and their size
    ...
    uint32_t resends                    = is_confirmation ? 3 : 0;
    // callbacks for request
    RF62X_answ_callback answ_clb        = rf627_smart_save_approx_table_v6_callback;
    RF62X_timeout_callback timeout_clb  = rf627_smart_save_approx_table_v6_timeout_callback;
    RF62X_free_callback free_clb        = rf627_smart_save_approx_table_v6_free_result_callback;
...
//
// RF627-Smart (v2.x.x)
// Receive Firmware Method
//
rfInt8 rf627_smart_receive_firmware_callback(char* data, uint32_t data_size, uint32_t device_id, void* rqst_msg)
{
    answ_count++;
    RF62X_msg_t* msg = rqst_msg;
    int32_t status = FALSE;
    ...
    if (existing)
    {
        ...
        ((answer*)msg->result)->payload = calloc(1, data_size);
...
rfInt8 rf627_smart_receive_firmware_timeout_callback(void* rqst_msg)
{
    RF62X_msg_t* msg = rqst_msg;
...
rfInt8 rf627_smart_receive_firmware_free_result_callback(void* rqst_msg)
{
    RF62X_msg_t* msg = rqst_msg;
...
rfBool rf627_smart_receive_firmware_by_service_protocol(
        rf627_smart_t* scanner, char** out, rfUint32* out_size, rfUint32 timeout)
{
    // cmd_name - this is logical port/path where data will be send
    char* cmd_name                      = "GET_FIRMWARE";
    // payload - this is the data to be sent and their size
    char* payload                       = NULL;
    uint32_t payload_size               = 0;
    // data_type - this is the type of packaging of the sent data
    ...
    uint32_t resends                    = is_confirmation ? 3 : 0;
    // callbacks for request
    RF62X_answ_callback answ_clb        = rf627_smart_receive_firmware_callback;
    RF62X_timeout_callback timeout_clb  = rf627_smart_receive_firmware_timeout_callback;
    RF62X_free_callback free_clb        = rf627_smart_receive_firmware_free_result_callback;
        ...
        if (result != NULL)
        {
            ...
            else
            {
                ...
                TRACE(TRACE_LEVEL_WARNING, TRACE_FORMAT_LONG,
                      "%s%s\n",
                      "Get response to request! "
                      "Response status: ","FIRMWARE_DOWNLOAD_FAILURE");
            }
        }else
        {
            TRACE(TRACE_LEVEL_WARNING, TRACE_FORMAT_LONG,  "%s", "No response to request!\n");
...
{
    if (scanner->approx_table.table_v6 == NULL)
    {
        scanner->approx_table.version = 6;
        scanner->approx_table.table_v6 = calloc(1, sizeof(rf627_smart_approx_table_v6_t));
    }else
    {
        if (scanner->approx_table.table_v6->poly_coef_x != NULL)
            free(scanner->approx_table.table_v6->poly_coef_x);
        if (scanner->approx_table.table_v6->poly_coef_z != NULL)
            free(scanner->approx_table.table_v6->poly_coef_z);
    }
    scanner->approx_table.table_v6->version = 0x06;
    scanner->approx_table.table_v6->crc_x = 0;
    scanner->approx_table.table_v6->crc_z = 0;
    scanner->approx_table.table_v6->serial = scanner->info_by_service_protocol.fact_general_serial;
    scanner->approx_table.table_v6->width = rf627_smart_get_parameter(
                scanner, "fact_sensor_width")->val_uint32->value;
    scanner->approx_table.table_v6->height = rf627_smart_get_parameter(
                scanner, "fact_sensor_height")->val_uint32->value;
    if (scanner->info_by_service_protocol.fact_general_mr < 100 && scanner->info_by_service_protocol.fact_general_xemr < 48)
        scanner->approx_table.table_v6->scaling_factor = 0.001;
    else if (scanner->info_by_service_protocol.fact_general_mr < 600 && scanner->info_by_service_protocol.fact_general_xemr < 500)
        scanner->approx_table.table_v6->scaling_factor = 0.01;
    else if (scanner->info_by_service_protocol.fact_general_mr < 1165 && scanner->info_by_service_protocol.fact_general_xemr < 1010)
        scanner->approx_table.table_v6->scaling_factor = 0.1;
    else
        scanner->approx_table.table_v6->scaling_factor = 1.0;

    scanner->approx_table.table_v6->polynomial_degree_x = 5;
    scanner->approx_table.table_v6->polynomial_degree_z = 5;
    scanner->approx_table.table_v6->time_stamp = time(NULL);

    scanner->approx_table.table_v6->poly_coef_x = (rfFloat*)calloc(
                scanner->approx_table.table_v6->width *
                scanner->approx_table.table_v6->polynomial_degree_x,
                sizeof (rfFloat));
    scanner->approx_table.table_v6->poly_coef_z = (rfFloat*)calloc(
                scanner->approx_table.table_v6->width *
                scanner->approx_table.table_v6->polynomial_degree_z,
                sizeof (rfFloat));
...
{
    return scanner->approx_table.table_v6;
}

rfBool rf627_smart_set_approx_table_v6(rf627_smart_t* scanner, rf627_smart_approx_table_v6_t* table)
{
    if (scanner->approx_table.table_v6 == NULL)
    {
        scanner->approx_table.version = table->version;
        scanner->approx_table.table_v6 = calloc(1, sizeof(rf627_smart_approx_table_v6_t));
    }else
    {
        if (scanner->approx_table.table_v6->poly_coef_x != NULL)
    ...
    scanner->approx_table.table_v6->version = table->version;
    scanner->approx_table.table_v6->crc_x = table->crc_x;
    scanner->approx_table.table_v6->crc_z = table->crc_z;
    scanner->approx_table.table_v6->serial = table->serial;
    scanner->approx_table.table_v6->width = table->width;
    scanner->approx_table.table_v6->height = table->height;
    scanner->approx_table.table_v6->scaling_factor = table->scaling_factor;

    scanner->approx_table.table_v6->polynomial_degree_x = table->polynomial_degree_x;
    scanner->approx_table.table_v6->polynomial_degree_z = table->polynomial_degree_z;
    scanner->approx_table.table_v6->time_stamp = table->time_stamp;

    scanner->approx_table.table_v6->poly_coef_x = (rfFloat*)calloc(
                scanner->approx_table.table_v6->width *
                scanner->approx_table.table_v6->polynomial_degree_x,
                sizeof (rfFloat));
    memcpy(scanner->approx_table.table_v6->poly_coef_x, table->poly_coef_x,
           scanner->approx_table.table_v6->width *
           scanner->approx_table.table_v6->polynomial_degree_x * sizeof (rfFloat));
    scanner->approx_table.table_v6->poly_coef_z = (rfFloat*)calloc(
                scanner->approx_table.table_v6->width *
                scanner->approx_table.table_v6->polynomial_degree_z,
                sizeof (rfFloat));
    memcpy(scanner->approx_table.table_v6->poly_coef_z, table->poly_coef_z,
           scanner->approx_table.table_v6->width *
           scanner->approx_table.table_v6->polynomial_degree_z * sizeof (rfFloat));
